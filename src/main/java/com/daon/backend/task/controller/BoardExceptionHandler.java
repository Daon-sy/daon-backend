...
public class BoardExceptionHandler {
    ...
    public ResponseEntity<CommonResponse<Void>> sameBoardExistsExceptionHandle(SameBoardExistsException e) {
    ...
    public ResponseEntity<CommonResponse<Void>> boardNotFoundExceptionHandle(BoardNotFoundException e) {
        log.info("{}", e.getMessage());
